export default {
  ...
  data: {
    ...
    SummonerHeal: {
      ...
      costBurn: "0",
      datavalues: {},
      effect: [null, [0.3], [66], [14], [0.5], [826], [0.5], [0], [0], [0], [0]],
      effectBurn: [null, "0.3", "66", "14", "0.5", "826", "0.5", "0", "0", "0", "0"],
      vars: [],
      key: "7",
      summonerLevel: 1,
      modes: [
    ...
    SummonerSmite: {
      ...
      key: "11",
      summonerLevel: 9,
      modes: ["URF", "CLASSIC", "ARSR", "ONEFORALL", "PRACTICETOOL", "NEXUSBLITZ", "TUTORIAL", "DOOMBOTSTEEMO"],
      costType: "No Cost",
      maxammo: "2",
      range: [500],
      rangeBurn: "500",
    ...
    SummonerTeleport: {
      ...
      key: "12",
      summonerLevel: 7,
      modes: ["ONEFORALL", "PRACTICETOOL", "CLASSIC", "TUTORIAL", "ULTBOOK", "ARSR", "ASSASSINATE", "DOOMBOTSTEEMO"],
      costType: "No Cost",
      maxammo: "-1",
      range: [25000],
      rangeBurn: "25000",
